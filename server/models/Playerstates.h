...
class Playerstates
{
  public:
    ...
    using PrimaryKeyType = std::tuple<std::string,std::string>;//user_id,session_id
     ...
     */
    explicit Playerstates(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Playerstates(const Json::Value &pJson) noexcept(false);
     ...
     */
    Playerstates(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Playerstates>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Playerstates>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where user_id = $1 and session_id = $2";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where user_id = $1 and session_id = $2";
        return sql;
    }

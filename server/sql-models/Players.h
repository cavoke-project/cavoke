...
public:
    ...
    using PrimaryKeyType =
        std::tuple<std::string, std::string>;  // session_id,user_id
     ...
     */
    explicit Players(const drogon::orm::Row &r,
    ...
    /// Get the value of the column player_id, returns the default value if the
    /// column is null
    ...
    /**  For column score  */
    /// Get the value of the column score, returns the default value if the
    /// column is null
    ...
    /// Get the value of the column playerstate, returns the default value if
    /// the column is null

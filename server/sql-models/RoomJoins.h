...
public:
    ...
    using PrimaryKeyType =
        std::tuple<std::string, std::string>;  // room_id,user_id
     ...
     */
    explicit RoomJoins(const drogon::orm::Row &r,
     ...
     */
    explicit RoomJoins(const Json::Value &pJson) noexcept(false);
...
private:
    friend drogon::orm::Mapper<RoomJoins>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<RoomJoins>;
#endif
...
public:
    ...
    static const std::string &sqlForDeletingByPrimaryKey() {
        static const std::string sql =
            "delete from " + tableName + " where room_id = $1 and user_id = $2";
        return sql;
    }
